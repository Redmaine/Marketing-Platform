...
export async function reconceiveAfterSubjectReject(
  ...
  const feedback =
    ...
    `unlettered physical emblem from its menu for the institution, process or capability this post is actually about (for tactics and capability: the terrain model, the parapet, the treeline, the tracks — never a radio, binoculars, a net or any other piece of kit, which the review stage counts as military equipment), set in the real place if one is named. ` +
